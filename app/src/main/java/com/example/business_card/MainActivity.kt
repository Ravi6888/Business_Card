        ...
        setContent {
            Business_CardTheme {
                Surface(modifier = Modifier
                    ...
                    Logobar(
                        name = stringResource(R.string.textname),
                        title = stringResource(R.string.titlename),
                    )
                    Details(
                        phone = stringResource(R.string.phone_no),
                        social = stringResource(R.string.social_media),
                        gmail = stringResource(R.string.gmail)
                    )
                }
            }
        }
